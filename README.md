...
```json
{
  "versionCode": 137,
  "versionName": "1.3.7",
  "apkFile": "short-video-android-v1.3.7-debug.apk",
  "sha256": "9ac8c7003762926099b929ad3e482091317aa3aec0ef8c2dae6ca61bd8e02589",
  "size": 22095924,
  "notes": "修复大型 ASMR 扫描的 SQLite 临时空间错误和底部播放器点击穿透，并更新应用图标。"
}
```
