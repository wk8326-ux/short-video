...
- **2026-08-18** - Use translucent white playback chrome with dark foreground content, and keep the primary navigation close to the top safe-area edge. *Why:* Black translucent controls disappear against dark video and lower navigation placement covers more of the frame.
