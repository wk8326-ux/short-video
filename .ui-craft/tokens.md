...
- Playback chrome: translucent near-white `#F7F7F5` at 87% opacity, dark `#18191B` foreground, and a subtle white outline; preserve dark text gradients where video contrast requires them.
